...
if($archivo = fopen($rutaCompleta, "a+")){
	...
	*constante PHP_EOL o con \r\n para Windows*/
	...
	//Sino rebobino no puedo leer porque tengo el puntero al final
	rewind ($archivo);
	...
	rewind ($archivo);
	//Con gets no utilizo nl2br porque lee una línea en cada llamada
	//Para leer todo el fichero tengo q utilizar un bucle con feof (fin de fichero) como condición de fin de lectura
